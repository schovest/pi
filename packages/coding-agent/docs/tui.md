...
**Source:** [`@schovest/pi-tui`](https://github.com/schovest/pi/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@schovest/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@schovest/pi-tui";
...
Import from `@schovest/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@schovest/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@schovest/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@schovest/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@schovest/pi-coding-agent";
import { Markdown } from "@schovest/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@schovest/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@schovest/pi-coding-agent";
import { DynamicBorder } from "@schovest/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@schovest/pi-tui";
...
```typescript
import { BorderedLoader } from "@schovest/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@schovest/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@schovest/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@schovest/pi-tui";
...
import { matchesKey, truncateToWidth } from "@schovest/pi-tui";
