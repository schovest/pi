...
import type { AssistantMessage, Model } from "@schovest/pi-ai";
...
vi.mock("@schovest/pi-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@schovest/pi-ai")>();
	return {
		...actual,
