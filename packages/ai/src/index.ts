...
// Legacy API exports for backward compatibility (defined directly in compat.ts,
// not re-exported from source modules — avoids circular-dependency issues with
// compat.ts's own `export * from "./index.ts"`).
export {
	complete,
	completeSimple,
	getApiProvider,
