...
```bash
npm install @schovest/pi-ai
```

TypeBox exports are re-exported from `@schovest/pi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@schovest/pi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@schovest/pi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@schovest/pi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@schovest/pi-ai';
...
```typescript
import { getImageModel, generateImages } from '@schovest/pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@schovest/pi-ai';
...
```typescript
import { getModel, stream } from '@schovest/pi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@schovest/pi-ai';
...
```typescript
import { Model, stream } from '@schovest/pi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@schovest/pi-ai';
...
```typescript
import { getModel, complete, Context } from '@schovest/pi-ai';
...
```typescript
import { Context, getModel, complete } from '@schovest/pi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@schovest/pi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@schovest/pi-ai';
...
```bash
npx @schovest/pi-ai login              # interactive provider selection
npx @schovest/pi-ai login anthropic    # login to specific provider
npx @schovest/pi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@schovest/pi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@schovest/pi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@schovest/pi-ai/oauth';
...
```typescript
import { getModel, complete } from '@schovest/pi-ai';
import { getOAuthApiKey } from '@schovest/pi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@schovest/pi-ai`
