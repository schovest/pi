...
import { parsePlan, inferDependencies } from "../src/plan/plan-parser.ts";
...
describe("inferDependencies", () => {
  it("infers dependency from file reference", () => {
    const steps: PlanStep[] = [
      ...
      { id: "s2", text: "Import types from packages/agent/src/plan/plan-types.ts", status: "pending", dependencies: [] },
    ];
