...
* **[@schovest/pi-ai](packages/ai)**: Unified multi-provider LLM API (OpenAI, Anthropic, Google, …)
...
| **[@schovest/pi-agent-core](packages/agent)** | Agent runtime with tool calling and state management |
| **[@schovest/pi-coding-agent](packages/coding-agent)** | Interactive coding agent CLI |
| **[@schovest/pi-tui](packages/tui)** | Terminal UI library with differential rendering |

For Slack/chat automation and workflows see [schovest/pi-chat](https://github.com/schovest/pi-chat).
